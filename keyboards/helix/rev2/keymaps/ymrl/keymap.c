...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Del  | Down | Alt  | GUI  |Space |Lawer |Raise |Shift | GUI  | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  KC_DEL,  KC_DOWN, KC_LALT, KC_LGUI, KC_SPC,  LOWER,   RAISE,   KC_RSFT, KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
